    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "jean@dupont.fr", "Jean", "Dupont", "0601020304" },
                    { 2, "sophie@martin.fr", "Sophie", "Martin", null }
                });
            ...
            migrationBuilder.InsertData(
                table: "Cars",
                columns: new[] { "Id", "CarModelId", "DailyRate", "FuelType", "LicensePlate", "NumberOfSeats", "Year" },
                values: new object[,]
                {
                    { 1, 1, 45m, "Petrol", "AB-123-CD", 5, 2021 },
                    { 2, 2, 50m, "Diesel", "EF-456-GH", 5, 2022 },
                    { 3, 3, 90m, "Electric", "IJ-789-KL", 5, 2023 }
                });
